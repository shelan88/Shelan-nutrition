...
export default function InfoHub() {
  ...
  return (
    <section id="info-hub" className="py-24 bg-gradient-to-b from-white via-lavender-50/60 to-white">
          ...
          {t.sections.map((section: (typeof t.sections)[number], i: number) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-3xl p-9 bg-gradient-to-br from-lavender-100 to-white border border-lavender-200"
              >
                <div className="w-14 h-14 rounded-2xl bg-lavender-100 flex items-center justify-center mb-6">
                  <Icon className="text-lavender-600" size={26} />
                </div>
