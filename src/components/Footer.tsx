...
const InstagramIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5">
    <defs>
      <linearGradient id="instagram-native-gradient" x1="0%" y1="100%" x2="100%" y2="0%">
    ...
    <path
      fill="url(#instagram-native-gradient)"
...
const TelegramIcon = () => (
  <svg viewBox="0 0 24 24" fill="#29B6F6" className="w-5 h-5">
