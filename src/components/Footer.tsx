...
export default function Footer() {
  ...
  return (
    <footer className="section-dark bg-gradient-to-br from-deep-purple to-soft-purple text-ivory-muted pt-16 pb-8 border-t border-white/10">
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="w-10 h-10 rounded-full bg-white/10 border border-white/10 flex items-center justify-center hover:bg-primary-pink/40 hover:text-white transition-colors"
            >
              <AtSign size={18} />
            </a>
            <a
