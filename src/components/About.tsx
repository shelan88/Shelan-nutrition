...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 bg-gradient-to-b from-white via-lavender-50/40 to-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="aspect-[4/5] max-w-md rounded-[2rem] bg-gradient-to-br from-rose-100 via-lavender-50 to-lavender-100 flex items-center justify-center shadow-xl">
            <span
