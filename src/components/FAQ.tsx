...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 bg-pink-blush/10">
        ...
        <div className="space-y-4">
          {t.items.map((item: { question: string; answer: string }, i: number) => {
            ...
            return (
              <div
                key={i}
                className="bg-white rounded-2xl border border-purple-secondary/10 shadow-md shadow-purple-primary/10 overflow-hidden"
              >
                <button
                ...
                >
                  ...
                  <motion.span
                    ...
                    className="shrink-0 text-peach-warm"
                  >
                    <ChevronDown size={20} />
                  </motion.span>
                </button>
